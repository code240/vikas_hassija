...
if($row!=0){
    while($r = mysqli_fetch_assoc($data)){
        $course[$i]  = '<i class="fas fa-hand-point-right" style="color:red;"></i> &nbsp;&nbsp;';
        $course[$i] .= $r["course"];
        $course[$i] .= ".<br>";
        $i++;
    }
...
<body>
        ...
        <div class="container-fluid row top-row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-12 top-col top-col-2 top-col-right">
                <div class="top-options-div">
                    ...
                    <a href="<?php $department_home; ?>" target="_blank" style="text-decoration: none;color:inherit"><span class="opt">Department Home</span></a>
                </div>
    ...
    <div class="location-div">
        ...
        <a href="index.php" style="text-decoration: none; color:inherit">Home </a> &rsaquo; Courses &rsaquo;
    </span> &nbsp;
    </div>
...
<div class="start-banner">
    <span class="word-start" id="currentheading">Courses &nbsp<i class="fas fa-caret-right" id="arrowicon"></i></span>
...
<div class="mobi-option-div" id="mobi-menubar">
    ...
    <a href="course.php" style="text-decoration: none;"><span class="mobi-opt mobi-opt-2 active">Courses</span></a>
...
<nav class="sidenavbar">
    ...
    <span class="navbar-options nav-2"><b>Course &#8250;</b></span>
...
<section class="sidesection">
    ...
    <p class="education-info coursename">
    <?php
            if($row != 0){
                for($j=0;$j<$i;$j++){
                    echo $course[$j];
    ...
    <p class="education-info coursename">
        <i class="fas fa-hand-point-right" style="color:red;"></i> &nbsp;&nbsp; Python, R, Java, C/C++, Node Js, React JS, Ethereum, Hyper ledger Fabric, Solidity, LaTex, MATLAB    
    </p>
        ...
        <div class="col-xl-6 col-lg-8 col-md-12 col-12 adressive-block">
            <div class="for-bottom-logo">
                <div class="for-bottom-image">
                    <img src="media/<?php echo $logo; ?>" onclick="window.location.assign('https://www.jiit.ac.in/');"  alt="Jiit-logo" class="bottom-logo">
                </div>
