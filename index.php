...
<div class="start-banner">
    <span class="word-start" id="currentheading">Profile &nbsp<i class="fas fa-caret-right" id="arrowicon"></i></span>
...
<section class="sidesection">
    ...
    <p class="education-info">
        <b>PhD.</b> (Thesis submission in process) JIIT, Noida (co-supervised by Dr. Vinay Chamola, BITS-Pilani).    <span class="time-period">Aug. 2018 – Present</span><br>
        <b>M.S.</b> (Tele-Communication and Software Engg.), BITS-Pilani, Rajasthan.    <span class="time-period">Jun. 2012 – Jun. 2014</span><br>
        <b>B.E</b>. (Hons) Information Technology, BRCM-CET, MDU, Rohtak.       <span class="time-period"> Aug. 2006 – May 2010 </span>
    </p>
    <h2 class="info-subheading">
        Experience:
    </h2>
